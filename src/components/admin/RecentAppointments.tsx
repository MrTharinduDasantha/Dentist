...
const RecentAppointments = () => {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case "CONFIRMED":
        return (
          <Badge className="bg-blue-100 text-blue-800 hover:bg-blue-300 transition-colors duration-300">
            CONFIRMED
          </Badge>
        );
      case "COMPLETED":
        return (
          <Badge className="bg-green-100 text-green-800 hover:bg-green-300 transition-colors duration-300">
            COMPLETED
          </Badge>
        );
      default:
